...
public class RichEditor extends WebView {
    ...
    //wang_editor.html
    private static final String SETUP_HTML = "file:///android_asset/wang_editor.html";
    ...
    public RichEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        addOnLayoutChangeListener((v, left, top, right, bottom, oldLeft, oldTop, oldRight, oldBottom) -> {
                    ...
                    Log.i("LayoutChange",dp+"dp==" + getHeight()+"px");
                    if (dp == 0) return;
                    setEditorHeight(dp);
                }
        );
     ...
     */
    public void setEditorHeight(int px, boolean needF) {
    ...
    public void setFontSize(int fontSize) {
        if (fontSize > 7 || fontSize < 1) {
            Log.e(TAG, "Font size should have a value between 1-7");
        }
     ...
     * @param activity
     */
    public void initKeyboardChange(Activity activity){
